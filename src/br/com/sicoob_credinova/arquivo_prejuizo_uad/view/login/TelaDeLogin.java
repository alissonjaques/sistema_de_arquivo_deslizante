package br.com.sicoob_credinova.arquivo_prejuizo_uad.view.login;
...
/**
 * A classe TelaDeLogin representa uma tela de login que permite que o usuário
 * entre ou não no sistema (para ter acesso ele deve digitar credenciais
 * válidas).
 *
 * @author Alisson
 */
public class TelaDeLogin extends javax.swing.JDialog { // declaração da classe
    ...
    * Campos da classe
    ...
    private void initComponents() {
        ...
        lSenha.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/sicoob_credinova/arquivo_prejuizo_uad/img/lock_32.png"))); // NOI18N
        lSenha.setText("Senha:");

        pfSenha.setFont(new java.awt.Font("SansSerif", 0, 13)); // NOI18N

        btnConfirmar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/sicoob_credinova/arquivo_prejuizo_uad/img/ico_processado.png"))); // NOI18N
        ...
        btnCancelar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/sicoob_credinova/arquivo_prejuizo_uad/img/Cancel.png"))); // NOI18N
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        if (usuario == null) {
            ...
            if (null != usuario.getPerfil()) switch (usuario.getPerfil()) {
                case ADMINISTRADOR:
